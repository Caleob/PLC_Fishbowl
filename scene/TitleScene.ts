...
const DEMO_CHARACTERS = [
  { id: 'frizzle', name: 'MRS. FRIZZLE', role: 'STEAM Expert', color: '#4a9a7a', spriteIndex: 3, state: 'skeptical' as const },
  { id: 'spock', name: 'MR. SPOCK', role: 'Instructional Coach', color: '#e74c4c', spriteIndex: 1, state: 'thinking' as const },
  { id: 'knope', name: 'MRS. KNOPE', role: 'SEL Specialist', color: '#4477ee', spriteIndex: 2, state: 'reacting' as const },
  { id: 'gandalf', name: 'GANDALF', role: 'Philosopher', color: '#e44a9a', spriteIndex: 4, state: 'talking' as const },
];

const DEMO_QUOTES = [
  'The pacing is too fast here. We need to pause for student questions.',
  'Let\'s incorporate a hands-on activity. Make the science tangible!',
  'Are we checking for understanding? The objectives need to be explicit.',
  'Students need positive reinforcement. Let\'s celebrate their effort!',
  'Remember to connect this lesson to the bigger picture. Why does this topic matter to their lives?',
  'The text chat is moving quickly. We need to synthesize their comments.',
  'This lesson structure is solid, but are we offering multiple entry points for learning?',
  'A quick retrieval practice at the start would really solidify these concepts.',
];
