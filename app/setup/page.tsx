...
export default function SetupPage() {
  ...
  const hasProvider = isHosted || store.provider === 'gemma-local' || !!store.apiKey.trim();
    ...
    <div className="min-h-screen">
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 py-8 sm:py-12 relative">
        ...
        <div className="text-center mb-8 sm:mb-12 animate-fade-in">
          <div className="label-mono mb-3 sm:mb-4">Teacher Feedback Panel</div>
          ...
          <p className="mt-2 sm:mt-3 text-sm sm:text-base" style={{ color: 'var(--text-secondary)' }}>
            Assemble your panel of educators. Paste your transcript. Watch them debate.
          </p>
        </div>
