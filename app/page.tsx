  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col items-center w-full relative" style={{ zIndex: 2 }}>
        ...
        <div className="relative animate-fade-in w-full max-w-[700px]">
          ...
          >
            ...
            >
              ...
              <ellipse cx="16" cy="15" rx="9" ry="10" fill="none" stroke="#e8c44a" strokeWidth="2"/>
              <ellipse cx="16" cy="20" rx="6" ry="3" fill="none" stroke="#e8c44a" strokeWidth="1.5"/>
              <circle cx="13" cy="13" r="1.5" fill="#e8c44a"/>
              <path d="M14.5 13.5 Q16 11 17.5 13" stroke="#e8c44a" strokeWidth="1" fill="none" strokeLinecap="round"/>
            </svg>
            <span
              style={{
        ...
        >
          Your lesson. Four AI education experts. One honest conversation.
        </p>
        ...
        <div className="animate-fade-in animate-fade-in-delay-5 mt-3 flex flex-col items-center gap-3">
          ...
          >
            ...
            <span style={{ opacity: 0.2 }}>&middot;</span>
            <a
              href="https://github.com/Caleob/PLC_Fishbowl"
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center gap-1.5"
              style={{ textDecoration: 'none', color: 'inherit', fontSize: '11px', fontFamily: "'DM Mono', monospace", whiteSpace: 'nowrap' }}
